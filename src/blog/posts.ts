...
export const POSTS: BlogEntry[] = [
  {
    ...
    title: "How Much Vermicompost Per Plant? Spoon Chart for Pots",
    seoTitle: "How Much Vermicompost Per Pot & Plant (2026 Chart)",
    metaDescription:
      "Spoon chart: 6-inch pots need 4–5 tbsp every 30–45 days. Exact doses for pots, grow bags and plants — buy pure Sarvada vermicompost from ₹249.",
    excerpt:
      "Exact spoon, teacup and handful doses for Indian pots — how much per plant, how often every 30 days, and which pack to buy.",
    category: "Guides",
    readTime: "9 min read",
    date: "2026-02-04",
    ...
    keywords: [
      ...
      "how much vermicompost per plant",
      "how much vermicompost for potted plants",
      "how often to apply vermicompost",
      "how often to apply vermicompost to potted plants",
  ...
  },
  {
    ...
    title: "Vermicompost or Cow Dung: Which Is Better for Plants?",
    seoTitle: "Vermicompost or Cow Dung — Which Is Better? (2026)",
    metaDescription:
      "Vermicompost vs cow dung manure vs chemical fertilizer for Indian pots. Clear winner for balconies, burn-risk table, and when to buy each.",
    excerpt:
      "Vermicompost or cow manure — which is better? Honest burn-risk table for pots, beds and when chemical fertilizer still wins.",
    ...
    keywords: [
      ...
      "vermicompost or cow manure which is better",
      "vermicompost or cow dung which is better",
      "which is better vermicompost or cow dung manure",
      "which is better cow dung or vermicompost",
      "difference between vermicompost and cow dung manure",
